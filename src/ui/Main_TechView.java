 ...
 * @author izar
 */
public class Main_TechView extends javax.swing.JFrame {
    ...
    public Main_TechView() {
        ...
        try {
            ...
            Logger.getLogger(Main_TechView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        techview_panel = new javax.swing.JPanel();
        ...
        techview_panel.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        ...
        javax.swing.GroupLayout techview_panelLayout = new javax.swing.GroupLayout(techview_panel);
        techview_panel.setLayout(techview_panelLayout);
        techview_panelLayout.setHorizontalGroup(
            techview_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(techview_panelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(techview_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(techview_panelLayout.createSequentialGroup()
                        .addGroup(techview_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(techview_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, techview_panelLayout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                            ...
                            .addGroup(techview_panelLayout.createSequentialGroup()
                                .addGroup(techview_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(techview_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        techview_panelLayout.setVerticalGroup(
            techview_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(techview_panelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(techview_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(5, 5, 5)
                .addComponent(techview_panel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5, 5, 5))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(techview_panel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(6, 6, 6))
        );
    ...
    private void reset_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reset_btnActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Main_TechView.class
    ...
    private void add_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btnActionPerformed
        try {
            ...
            for (int i = 0; i < techs.size(); i++) {
                String s = techs.get(i).getId() + " - " + techs.get(i).getName() + " " + techs.get(i).getSurname();
            ...
            //this.addTicket_admin_tech_cb.setEnabled(false); // El técnico asignado siempre será el que ha hecho el login
            this.addTicket_admin_priority_cb.setSelectedIndex(0);
            this.addTicket_admin_scalability_cb.setSelectedIndex(0);
            //this.addTicket_admin_scalability_cb.setEnabled(false); // La escalabilidad se pone automáticamente a Técnico
    ...
    private void updateTicket() {
        ...
        try {
            ...
            // Código para gestionar que solo puede cambiar estado y cerrar si puede
            // Si no le ha sido asignado
            if (selectedTicket.getTechnician() != Login.loggedUser.getId()) {
                data_priority_view_cb2.setEnabled(false);   // Cambiar prioridad
                closeTicket_view_btn.setEnabled(false);     // Cerrar el ticket
                description_view_ta2.setEditable(false);    // Modificar la descripción
                data_description_update_btn.setEnabled(false);
                tasksHistory_add_btn.setEnabled(false);     // Añadir al historial de tareas
            } else {
                data_priority_view_cb2.setEnabled(true);
                closeTicket_view_btn.setEnabled(true);
                description_view_ta2.setEditable(true);
                data_description_update_btn.setEnabled(true);
                tasksHistory_add_btn.setEnabled(true);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_TechView.class
    ...
    private javax.swing.JPanel techview_panel;
